                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4  col-md-6 col-sm-6">
                            <div className="single-footer-widget">
                                <h6>Bản tin</h6>
                                <p className="text-light">Cập nhập thông tin mới nhất về tôi</p>
                    ...
                    <div className="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
                        <p className="footer-text m-0 text-light" >{/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
                            Bản quyền <i className="fa fa-heart-o" aria-hidden="true" /> Dưỡng Đào
